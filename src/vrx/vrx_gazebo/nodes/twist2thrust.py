...
class Node():
    ...
    def callback(self,data):
        ...
        node.wamv1left_pub_angle.publish(0.0)
        node.wamv1right_pub_angle.publish(0.0)         

        node.wamv2left_pub.publish(1.0)
        node.wamv2right_pub.publish(1.0)
        node.wamv2left_pub_angle.publish(0.0)
        node.wamv2right_pub_angle.publish(0.0)       

        node.wamv3left_pub.publish(1.0)
        node.wamv3right_pub.publish(1.0)
        node.wamv3left_pub_angle.publish(0.0)
        node.wamv3right_pub_angle.publish(0.0)     

        node.wamv4left_pub.publish(1.0)
        node.wamv4right_pub.publish(1.0)
        node.wamv4left_pub_angle.publish(0.0)
        node.wamv4right_pub_angle.publish(0.0)     

        node.wamv5left_pub.publish(1.0)
        node.wamv5right_pub.publish(1.0)
        node.wamv5left_pub_angle.publish(0.0)
        node.wamv5right_pub_angle.publish(0.0)     
...
if __name__ == '__main__':
    ...
    node.wamv2left_pub = rospy.Publisher("/wamv2/thrusters/left_thrust_cmd",Float32,queue_size=10)
    node.wamv2right_pub = rospy.Publisher("/wamv2/thrusters/right_thrust_cmd",Float32,queue_size=10)
    node.wamv2left_pub_angle = rospy.Publisher('/wamv2/thrusters/left_thrust_angle', Float32, queue_size=1)
    node.wamv2right_pub_angle = rospy.Publisher('/wamv2/thrusters/right_thrust_angle', Float32, queue_size=1)
    node.wamv3left_pub = rospy.Publisher("/wamv3/thrusters/left_thrust_cmd",Float32,queue_size=10)
    node.wamv3right_pub = rospy.Publisher("/wamv3/thrusters/right_thrust_cmd",Float32,queue_size=10)
    node.wamv3left_pub_angle = rospy.Publisher('/wamv3/thrusters/left_thrust_angle', Float32, queue_size=1)
    node.wamv3right_pub_angle = rospy.Publisher('/wamv3/thrusters/right_thrust_angle', Float32, queue_size=1)
    node.wamv4left_pub = rospy.Publisher("/wamv4/thrusters/left_thrust_cmd",Float32,queue_size=10)
    node.wamv4right_pub = rospy.Publisher("/wamv4/thrusters/right_thrust_cmd",Float32,queue_size=10)
    node.wamv4left_pub_angle = rospy.Publisher('/wamv4/thrusters/left_thrust_angle', Float32, queue_size=1)
    node.wamv4right_pub_angle = rospy.Publisher('/wamv4/thrusters/right_thrust_angle', Float32, queue_size=1)
    node.wamv5left_pub = rospy.Publisher("/wamv5/thrusters/left_thrust_cmd",Float32,queue_size=10)
    node.wamv5right_pub = rospy.Publisher("/wamv5/thrusters/right_thrust_cmd",Float32,queue_size=10)
    node.wamv5left_pub_angle = rospy.Publisher('/wamv5/thrusters/left_thrust_angle', Float32, queue_size=1)
    node.wamv5right_pub_angle = rospy.Publisher('/wamv5/thrusters/right_thrust_angle', Float32, queue_size=1)
